...
func (x *ProjectDeleteCommand) Reset() {
	*x = ProjectDeleteCommand{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProjectDeleteCommand) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProjectDeleteCommand) ProtoMessage() {}

func (x *ProjectDeleteCommand) ProtoReflect() protoreflect.Message {
	mi := &file_proto_project_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProjectDeleteCommand.ProtoReflect.Descriptor instead.
func (*ProjectDeleteCommand) Descriptor() ([]byte, []int) {
	return file_proto_project_proto_rawDescGZIP(), []int{1}
}

func (x *ProjectDeleteCommand) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
var file_proto_project_proto_rawDesc = []byte{
	...
	,
...
var file_proto_project_proto_goTypes = []interface{}{
	...
	(*ProjectDeleteCommand)(nil), // 1: staffing.project.v1.ProjectDeleteCommand
...
var file_proto_project_proto_depIdxs = []int32{
	...
	1, // 1: staffing.project.v1.Project.DeleteProject:input_type -> staffing.project.v1.ProjectDeleteCommand
	2, // 2: staffing.project.v1.Project.CreateProject:output_type -> google.protobuf.Empty
	2, // 3: staffing.project.v1.Project.DeleteProject:output_type -> google.protobuf.Empty
...
func file_proto_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_project_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProjectDeleteCommand); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
